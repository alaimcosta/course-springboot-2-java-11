...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2022-01-05T05:56:07Z"), p1);
		Order o2 = new Order(null, Instant.parse("2022-01-07T05:56:07Z"), p2);
		Order o3 = new Order(null, Instant.parse("2022-01-09T05:56:10Z"), p1);
